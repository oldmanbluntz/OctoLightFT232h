...
plugin_package = "octoprint_octolightft232h"

# The plugin's human readable name. Can be overwritten within OctoPrint's internal data via __plugin_name__ in the
# plugin module
plugin_name = "OctoPrint-Octolightft232h"
...
# module
plugin_description = """Port of OctoLight by gigibu5 to work with Adafruit FT232H breakout board. Testing only, do not install."""
